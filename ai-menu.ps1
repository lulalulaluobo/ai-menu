...
function Select-Menu {
    ...
    while ($true) {
        ...
        for ($i = 0; $i -lt $optionCount; $i++) {
            if ($i -eq $selected) {
                Write-Host " $($i + 1). $($Options[$i]) " -ForegroundColor Black -BackgroundColor White
            } else {
...
function Start-MainMenu {
    ...
    while ($true) {
        ...
        for ($i = 0; $i -lt $optionCount; $i++) {
            if ($i -eq $selected) {
                Write-Host " $($i + 1). $($script:MAIN_MENU_OPTIONS[$i]) " -ForegroundColor Black -BackgroundColor White
            } else {
